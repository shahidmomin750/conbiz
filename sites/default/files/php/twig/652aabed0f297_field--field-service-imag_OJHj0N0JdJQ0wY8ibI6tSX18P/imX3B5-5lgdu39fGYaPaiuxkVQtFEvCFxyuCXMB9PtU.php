...
class __TwigTemplate_f43c681cc28dcf84e7612c52d1ab8bff extends Template
{
    private $source;
    private $macros = [];
...
{% set i = 0 %}
  {%- for item in items -%}
    ...
    {% if i == 1 %}
      ...
      {% endif %}
  {%- endfor -%}
</div>", "themes/custom/conbiz/templates/fields/field--field-service-images--teaser.html.twig", "C:\\xampp\\htdocs\\conbiz_demo\\themes\\custom\\conbiz\\templates\\fields\\field--field-service-images--teaser.html.twig");
    }
