...
class __TwigTemplate_c2b4fbe9864afed5545189ee65063631 extends Template
{
    private $source;
    private $macros = [];
...
{% block content %}
  {% if site_logo %}
    <a href=\"{{ path('<front>') }}\" title=\"{{ 'Home'|t }}\" rel=\"home\" class=\"site-branding-logo\">
      {% if setting_logo %}
         ...
         <img class=\"logo-white\" src=\"{{ site_logo|replace({'logo.svg': 'logo-white.png'}) }}\" alt=\"{{ 'Home'|t }}\" />
      {% else %}  
  ...
  {% endif %}
{% endblock %}
", "themes/custom/conbiz/templates/block/block--system-branding-block.html.twig", "C:\\xampp\\htdocs\\conbiz_demo\\themes\\custom\\conbiz\\templates\\block\\block--system-branding-block.html.twig");
    }
