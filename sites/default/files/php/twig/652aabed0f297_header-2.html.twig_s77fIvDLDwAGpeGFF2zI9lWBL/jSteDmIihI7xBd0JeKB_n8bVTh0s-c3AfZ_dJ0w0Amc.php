...
class __TwigTemplate_9d923ac6514e20fd958a36c26494bc4d extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<header id=\"header\" class=\"header-2\">
  {% if page.topbar %}
    <div class=\"topbar\">
      <div class=\"container\">
        <div class=\"row\">
  ...
  {% endif %}  
   ...
   <div class=\"header-main {{ class_sticky }} {% if page.language %} has-language-block{% endif %}\">
      <div class=\"container header-content-layout\">
          <div class=\"row\">
            <div class=\"col-12\">
              <div class=\"header-main-inner p-relative\">
...
", "themes/custom/conbiz/templates/page/header-2.html.twig", "C:\\xampp\\htdocs\\conbiz_demo\\themes\\custom\\conbiz\\templates\\page\\header-2.html.twig");
    }
