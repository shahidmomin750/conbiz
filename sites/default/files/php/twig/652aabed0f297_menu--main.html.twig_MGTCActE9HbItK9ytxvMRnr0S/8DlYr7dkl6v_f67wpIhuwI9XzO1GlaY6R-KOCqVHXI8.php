...
class __TwigTemplate_5506f6bbc09acddd9b812e6e833f107d extends Template
{
    private $source;
    private $macros = [];
  ...
  {% if items %}
    ...
    {% for item in items %}
      ...
      <li {{ item.attributes.addClass(classes)|without('gva_icon', 'gva_class', 'gva_layout_columns', 'gva_block', 'gva_layout') }}>
        <a data-link_id=\"link-{{random()}}\" href=\"{{ item.url }}\">{% if item.attributes.gva_icon != '' %} <i class=\"fa {{ item.attributes.gva_icon }}\"></i>{% endif %}
...
", "themes/custom/conbiz/templates/navigation/menu--main.html.twig", "C:\\xampp\\htdocs\\conbiz_demo\\themes\\custom\\conbiz\\templates\\navigation\\menu--main.html.twig");
    }
