...
class __TwigTemplate_fe386611a6b8c7a27e4190d311e4e137 extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
    ...
    {
        return new Source("<article class=\"testimonial-node-1\">      
   <div class=\"testimonial-content\">
      <div class=\"content-body\">
         <div class=\"content-inner\">
            <div class=\"quote\">{{ fields.body.content|striptags|trim }}</div>      
            <div class=\"info\">
               <h3 class=\"name\">{{ fields.field_testimonial_name.content }}</h3>
               <div class=\"job\">{{ fields.field_testimonial_job.content }}</div>   
            </div>  
         </div>
      </div>
      <div class=\"avatar\">
         {{ fields.field_testimonial_avatar.content }}
      </div>
   </div>
</article>
  ", "themes/custom/conbiz/templates/views/testimonial/views-view-fields--testimonial-1.html.twig", "C:\\xampp\\htdocs\\conbiz_demo\\themes\\custom\\conbiz\\templates\\views\\testimonial\\views-view-fields--testimonial-1.html.twig");
    }
