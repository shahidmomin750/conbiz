...
class __TwigTemplate_84bb7061a5fb020c5d97a4d6e9893d73 extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"team-block team-v1\">
    ...
    <div class=\"team-content\">
      ...
      <div class=\"team-inner\">
        ...
        <a href=\"{{ url }}\" class=\"btn-theme\"><i class=\"fa fa-angle-double-right\" aria-hidden=\"true\"></i></a>
      </div>
...
{% elseif view_mode == \"teaser_2\" %}
  ...
  <div class=\"team-block team-v2\">
    <div class=\"team-image\">
      {{ content.field_team_image }}
      <a href=\"{{ url }}\" class=\"btn-theme\"><i class=\"fa fa-plus\" aria-hidden=\"true\"></i></a>
    </div>
    <div class=\"team-content\"><div class=\"team-inner\">
      <h3 class=\"team-name\"><a href=\"{{ url }}\">{{ node.field_team_name.value|e }}</a></h3>
      {% if node.field_team_position.value %}   
    ...
    <div class=\"team-inner\">
      <div class=\"row\">
        <div class=\"col-lg-5 col-md-6 col-sm-12 col-xs-12\">
          <div class=\"team-image\">
            {{ content.field_team_image }}
            <div class=\"team-name\">
              <h2 class=\"name\">{{ node.field_team_name.value|e }}</h2>
        ...
        <div class=\"col-lg-7 col-md-6 col-sm-12 col-xs-12\">
          <div class=\"team-content\">
            <div class=\"team-description\">
              <h2 class=\"name\">{{'Information'|t}}</h2>
              <div class=\"content-inner\">{{ content.field_team_description }}</div>
            </div>
            <div class=\"team-skills\">
              <h3>{{'Best Skills'|t}}</h2>
              <div class=\"team-skill-content\">
                {% for item in node.field_team_skills %}
                  ...
                  {% if skill['0'] and skill['1'] %}
                    <div class=\"team-skill\">
                      <div class=\"pieChart\" data-bar-color=\"#f94d1c\" data-bar-width=\"130\" data-percent=\"{{ skill['1'] }}\">
                         <span>{{ skill['1'] }}%</span>  
                      </div>
                      <div class=\"skill-label\">{{ skill['0'] }}</div>
                    </div>
                  {% endif %}  
                {% endfor %} 
              </div>
      ...
      <div class=\"team-info\">
        <div class=\"row\">
          <div class=\"col-lg-5 col-md-6 col-sm-12 col-xs-12\">
            <div class=\"team-contact\">
              <h2 class=\"name hidden\">{{'Contact Info'|t}}</h2>
              <div class=\"content-inner\">{{ content.field_team_contact }}</div>
            </div>
          </div>
          <div class=\"col-lg-7 col-md-6 col-sm-12 col-xs-12\">
            <div class=\"team-education\">
              <h2 class=\"name hidden\">{{'Education'|t}}</h2>
...
", "themes/custom/conbiz/templates/node/node--team.html.twig", "C:\\xampp\\htdocs\\conbiz_demo\\themes\\custom\\conbiz\\templates\\node\\node--team.html.twig");
    }
